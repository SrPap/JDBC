...
public class Cliente {
    ...
    public String toString() {
        return "Cliente [idCliente=" + idCliente + ", codigoCliente=" + codigoCliente + ", nombreCliente=" + nombreCliente
                + ", nombreContacto=" + nombreContacto + ", apellidoContacto=" + apellidoContacto + ", telefono=" + telefono
    ...
    public void imprimirInformacionBasica() {
        System.out.println("ID: " + this.idCliente + ", Nombre: " + this.nombreCliente + ", Apellido: " + this.apellidoContacto);
    }
